...
class ClustererConfig:
    ...
    Default settings:
    - algorithm_mode="hdbscan" with iterative residual clustering
    - iterative_accept_probability=0.8 (accept high-confidence members)
    - iterative_residual_ratio_stop=0.10 (stop at 10% residual)
    ...
    # "idea_embedding", "rung_1_embedding", "rung_2_embedding", "concept_type_embedding", "ladder_embedding"
    clustering_embedding_field: str = "ladder_embedding"

    # Mode: "auto", "hdbscan", "agglomerative", "kmeans"
    algorithm_mode: str = "hdbscan"
    ...
    iterative_accept_probability: float = 0.8   # points need prob >= this to be accepted
    ...
    # Supported fields: "idea", "instance", "rung_1", "rung_2", "concept_type", "ladder"
