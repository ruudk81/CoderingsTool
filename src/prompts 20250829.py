...
4. Provide a name for the theme
    - Syntax for theme_name: [The most atomic, singular concept that unifies the theme_statement]
...
[
  {{
    "theme_id": 1,
    "theme_name": "<theme name here, in  ≤10 words, in {language}>",
