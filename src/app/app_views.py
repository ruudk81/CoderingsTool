...
STEP_VIEWS: Dict[int, StepView] = {
    ...
    4: StepView(phases=("classifier_facet_discovery",
                        "classifier_facet_consolidation",
                        "classifier_facet_assignment",
                        "classifier_facet_refinement",
                        "classifier_attribute_discovery",
                        "classifier_attribute_consolidation",
                        "classifier_attribute_assignment",
                        "classifier_attribute_refinement",
                        "classifier_valence_merge"),
                stats=stats_taxonomy),
    5: StepView(phases=("codegen_relations", "codegen_umbrella_merge", "codegen_writer",
                        "codegen_mece_detect", "codegen_mece_probe"),
