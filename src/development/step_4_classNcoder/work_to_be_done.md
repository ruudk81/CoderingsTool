...
- "Financiële producten en diensten" (what Merk X offers)
- "Financiële kenmerken, voorwaarden en kosten" (properties of what Merk X offers)
- "Financiële functionaliteit en transacties" (using what Merk X offers)
- "Financiële gezondheid, betrouwbaarheid en prestaties" (how Merk X performs)
- "Financiële verantwoordelijkheid, ethiek en duurzaamheid" (how Merk X invests)
- "Financiële gedragingen en doelstellingen" (what customers do / Merk X's goals)
