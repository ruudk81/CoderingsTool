...
def main(cluster_id=None, var_lab=None):
    """Simple main function with optional parameters
    
    Args:
        cluster_id: Specific cluster ID to test (default: None for random selection)
    ...
    # Display cluster_id info
    if cluster_id is not None:
        print(f"Using specified cluster: {cluster_id}")
    else:
        print("Using random cluster selection")
...
if __name__ == "__main__":
    ...
    main(cluster_id=args.cluster_id, var_lab=args.var_lab)