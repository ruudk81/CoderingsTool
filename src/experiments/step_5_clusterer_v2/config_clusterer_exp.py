...
# Multi-pass "all" populates all 4 fields; default to idea_embedding.
FORMAT_TO_EMBEDDING_FIELD = {
    "idea": "idea_embedding",
    "node": "idea_embedding",              # single-pass → stored in idea_embedding
    "category": "idea_embedding",          # single-pass → stored in idea_embedding
    "taxonomy": "idea_embedding",          # single-pass → stored in idea_embedding
    "all": "idea_embedding",               # multi-pass → default to idea
}
...
class ClustererConfig:
    ...
    # Which embedding field to cluster on: "auto", "idea_embedding", "node_embedding", "category_embedding", "taxonomy_embedding"
    ...
    # ==========================================================================
    # THEME GENERATION (Phase B) - Per-cluster topic identification
    # ==========================================================================

    generate_llm_labels: bool = True  # Controls Phase B theme generation
    ...
    # ==========================================================================
    # MECE TOPIC CONSOLIDATION (Phase C) - Merge themes into MECE topics
    # ==========================================================================

    generate_mece_topics: bool = True
    mece_model: str = "gpt-4.1"
    mece_temperature: float = 0.3
    mece_max_tokens: int = 4000
