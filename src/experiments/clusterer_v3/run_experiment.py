...
"""
Clusterer V3 Experiment Runner
...
The old clusterer is archived at src/utils/old/clusterer_v2.py.

Usage:
    cd src && python -m experiments.clusterer_v3.run_experiment

Toggle modes:
    USE_EXPERIMENTAL_CLUSTERER = True  -> Uses PRODUCTION clusterer (migrated v3)
    USE_EXPERIMENTAL_CLUSTERER = False -> Uses OLD clusterer (archived v2)
...
# =============================================================================
# TOGGLE: Use production clusterer (migrated v3) or old clusterer (archived v2)
# =============================================================================
USE_EXPERIMENTAL_CLUSTERER = True

import models
from utils.cacheManager import CacheManager, generate_enhanced_variable_key

# Import the appropriate Clusterer
if USE_EXPERIMENTAL_CLUSTERER:
    # Use PRODUCTION clusterer (migrated from v3)
    ...
    # Use OLD clusterer (archived v2)
    from utils.old.clusterer_v2 import ClustererV2 as Clusterer
    # Note: v2 has its own embedded config
    ClustererV3 = Clusterer
    ClustererV3Config = None  # Will fail if used - old v2 has different config
