#%%
"""
IdeaExtractor V2 Experiment Runner - VERSION 2
...
Usage:
    cd src && python -m experiments.ideaExtractor_v2.run_experimentv2

Toggle modes:
    USE_EXPERIMENTAL_EXTRACTOR = True  -> Uses local ideaExtractor_experimentalv2.py + local prompts.py
...
def run_experiment(config: ExperimentConfig = None):
    ...
    print("\n" + "=" * 80)
    print("IDEA EXTRACTOR V2 EXPERIMENT - VERSION 2")
    print("=" * 80)
    ...
    if config.use_experimental_extractor:
        print("\n🔬 Using EXPERIMENTAL ideaExtractor v2 (local)")
        from experiments.ideaExtractor_v2.ideaExtractor_experimentalv2 import IdeaExtractor
    else:
