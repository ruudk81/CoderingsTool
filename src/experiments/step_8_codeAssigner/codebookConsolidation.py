...
Usage (standalone):
    cd src && python -m experiments.step_8_codeAssigner.codebookConsolidation

Usage (from other modules):
    from experiments.step_8_codeAssigner.codebookConsolidation import CodebookConsolidator
...
from experiments.step_8_codeAssigner.prompts_exp import AXIAL_CONSOLIDATION_PROMPT
