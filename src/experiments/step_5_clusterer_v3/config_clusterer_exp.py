"""
Clusterer-specific configuration - V3 EXPERIMENTAL VERSION

V3 changes from V2:
- Removed: Representation (c-TF-IDF, MMR, TF-IDF) config
- Removed: Theme generation (Phase B) config
- Removed: MECE consolidation (Phase C) config
- Added: Map-Reduce MECE (Phase 7) config

This is an isolated copy for experimentation in step_5_clusterer_v3.
Changes here do NOT affect the production pipeline.

Original: src/experiments/step_5_clusterer_v2/config_clusterer_exp.py
"""
...
class ClustererConfig:
    """
    Configuration for Clusterer V3 with map-reduce MECE topic extraction.
    ...
    # ==========================================================================
    # MAP-REDUCE MECE (Phase 7) - Per-cluster topic extraction
    # ==========================================================================
