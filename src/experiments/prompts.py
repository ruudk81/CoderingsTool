...
# V2: Without keywords section (keywords can confuse LLM for semantic/intent clusters)
CLUSTER_DESCRIPTION_PROMPT_V2 = """You are a qualitative researcher applying Braun & Clarke's (2006) thematic analysis method to analyze survey response clusters.
...
1. Read all response ideas carefully
2. Identify the common atomic theme that unifies these responses
3. Extract 3-5 key concepts present in this cluster
