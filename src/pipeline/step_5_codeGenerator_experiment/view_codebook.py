...
Usage:
    cd src && python -m pipeline.step_5_codeGenerator_experiment.view_codebook
"""
...
def main():
    ...
    if mece_cache is None:
        ...
        print("Run codebook generation first: python -m pipeline.step_5_codeGenerator_experiment.run_codeGenerator")
        return
