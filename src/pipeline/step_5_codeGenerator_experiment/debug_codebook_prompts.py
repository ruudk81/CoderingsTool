...
Usage:
    cd src && python -m pipeline.step_5_codeGenerator_experiment.debug_codebook_prompts
"""
...
from pipeline.step_5_codeGenerator_experiment.prompts_codeGenerator import (
...
def main():
    ...
    if data is None:
        ...
        print("  cd src && python -m pipeline.step_5_codeGenerator_experiment.run_codeGenerator")
        return
