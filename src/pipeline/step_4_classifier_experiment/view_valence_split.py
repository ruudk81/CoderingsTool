...
Usage:
    cd src && python -m pipeline.step_4_classifier_experiment.view_valence_split
"""
...
from pipeline.step_4_classifier_experiment.valence_consolidator import detect_valence_splits
