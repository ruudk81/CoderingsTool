...
from pipeline.step_4_classifier_experiment.domain_discoverer import DomainDiscoverer, PartitionLabelMapping
from pipeline.step_4_classifier_experiment.classifier import TaxonomyClassifier, TaxonomyResult
from pipeline.step_4_classifier_experiment.taxonomy_health import (
...
def run_taxonomy(filename: str = FILENAME, var_name: str = VARIABLE,
    ...
    if CONFIG.debug_stop_after_phase is None or CONFIG.debug_stop_after_phase >= 8:
        import asyncio
        from pipeline.step_4_classifier_experiment.valence_consolidator import ValenceConsolidator
        cache_manager = CacheManager()
