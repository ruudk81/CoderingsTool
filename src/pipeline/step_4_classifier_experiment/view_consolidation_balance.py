...
Usage:
    cd src && python -m pipeline.step_4_classifier_experiment.view_consolidation_balance
"""
...
from pipeline.step_4_classifier_experiment import consolidation_balance_core as core
