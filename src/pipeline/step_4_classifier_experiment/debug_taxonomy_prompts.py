...
Usage:
    cd src && python -m pipeline.step_4_classifier_experiment.debug_taxonomy_prompts
"""
...
def main():
    ...
    if not prompts_files:
        ...
        print("  cd src && python -m pipeline.step_4_classifier_experiment.run_classifier")
        return
