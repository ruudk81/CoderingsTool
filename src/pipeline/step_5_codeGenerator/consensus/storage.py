...
Het vorige consolidatie-experiment logde proza; daardoor kostte elke
heranalyse opnieuw LLM-calls. Hier gaan de partities zelf naar JSON, dus een
andere tau of een andere meting kost achteraf niets.
"""
...
class RunSet:
    ...
    # dan verschuift elke drempel stil: tau=0,7 over 30 gevraagde runs is 21,
    # over 27 geslaagde is het 19.
    n_failed: int = 0
...
def load_runset(path: Path) -> RunSet:
    ...
    payload["runs"] = [[tuple(cluster) for cluster in run]
