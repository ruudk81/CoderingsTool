...
Run (from src/):
    python -m pipeline.step_4_classifier.view_consolidation_ab
...
from pipeline.step_4_classifier.view_assignments_attributes_raw import load_ideas_with_raw_attributes
