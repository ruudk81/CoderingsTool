"""
Configuration for Step 6: Code Generator (Codebook Generation).

Contains CodeDesignerConfig dataclass and operational constants for the
4-prompt inductive coding pipeline.
"""
from dataclasses import dataclass, field
from typing import Dict, Tuple, Optional, Literal

from config import DEFAULT_EMBEDDING_MODEL, DEFAULT_MODEL
...
class CodeDesignerConfig:
    """Configuration for the CodeGenerator system (4-prompt inductive coding pipeline)."""
